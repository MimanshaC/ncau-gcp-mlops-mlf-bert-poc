...
def evaluate_prediction_drift(
    ...
    from bert_model.data.data_ingestion import execute_bq_query
    from bert_model.monitoring import prediction_drift
    from bert_model.monitoring.inference_history_table import (
        fetch_historical_inference,
    )
    from bert_model.monitoring.metrics import (
        write_metrics_to_cloud_monitoring,
    )
    from bert_model.monitoring.metrics import write_metrics_to_table
